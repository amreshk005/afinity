          ...
          <div className="card flex-row border mt-3" style={{ height: "9rem" }}>
            ...
            <div className="card-body d-flex justify-content-between p-1 ">
              <div className="w-50">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="d-flex flex-column p-2 align-items-center ">
                    <span name="inc" className="p-1 bg-dark rounded-circle w-50 text-white text-center mb-1" onClick={(e) => quantityHandler(e, item)}>
                      +
                    </span>
                    <input type="number" value={item.quantity} style={{ width: "35px" }} readOnly />
                    <span name="dec" className="p-1 bg-dark rounded-circle w-50 text-white text-center mt-1" onClick={(e) => quantityHandler(e, item)}>
                      -
                    </span>
                  </div>
                </div>
              ...
              <div className="d-flex align-items-end">
                <button className="btn btn-dark rounded-0">Remove</button>
              </div>
            </div>
          </div>
        ))}
